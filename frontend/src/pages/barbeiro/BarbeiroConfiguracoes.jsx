        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <section className="space-y-4 md:col-span-2">
            ...
            <div className="bg-slate-50 dark:bg-[#111] p-8 rounded-[2.5rem] border border-slate-100 dark:border-white/5 space-y-6 shadow-sm">
              <p className="text-[11px] text-slate-400 uppercase font-black tracking-widest leading-relaxed">
                liberar acesso total aos relatórios e gestão de equipe.
              </p>
              <button 
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/80 backdrop-blur-sm">
          <div className="w-full max-w-xs bg-white dark:bg-[#111] border border-slate-200 dark:border-white/10 rounded-[2.5rem] p-8 space-y-6">
            <header className="text-center space-y-2">
              <h3 className="dark:text-white font-black uppercase text-[10px] tracking-[0.2em]">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      autoFocus
                      className="w-full bg-slate-50 dark:bg-black border border-slate-200 dark:border-white/10 rounded-2xl p-4 text-sm dark:text-white outline-none focus:border-[#e6b32a]"
                      value={senhaAtual}
