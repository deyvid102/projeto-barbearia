...
import { barbers, services, appointments, weeklyRevenue, barberPerformance, financialLogs, serviceDistribution } from '@/data/mockData';
...
import BarberKPIs from '../components/barber/BarberKPIs';
import BarberCharts from '../components/barber/BarberCharts';
import ScheduleGrid from "../components/barber/ScheduleGrid";
import ScheduleBlocker from "../components/barber/ScheduleBlocker";
...
console.log('Agendamentos hoje:', {agendadosHoje});
console.log('PASSANDO PRO KPIs:', {
  agendadosHoje,
  length: agendadosHoje.length
});
      ...
      <div className="pt-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-16">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-muted-foreground text-sm">Gestão completa + seu dashboard pessoal.</p>
          </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="bg-secondary/50 mb-8 flex-wrap h-auto gap-1">
            {[
              { value: 'my-dashboard', label: 'Meu Dashboard', icon: TrendingUp },
          ...
          {/* MY DASHBOARD (Barber view) */}
          <TabsContent value="my-dashboard" className="space-y-6">
            <BarberKPIs commissionToday={commissionToday} agendadosCount={agendadosHoje.length} pendingCount={pendingToday.length} completedCount={completedToday.length} />
            <ScheduleGrid />
            <BarberCharts revenueData={weeklyRevenue} serviceDistribution={serviceDistribution} avgTicket={avgTicket} periodLabel={periodLabels[period]} />
          </TabsContent>
          ...
          <TabsContent value="schedule" className="space-y-6">
            ...
            {/* Schedule Blocker for specific dates/times */}
            <ScheduleBlocker />
          </TabsContent>
